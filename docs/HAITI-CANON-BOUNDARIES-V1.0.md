...
```mermaid
flowchart TD
    Cycle["Cycle of Whispers<br/>Universal heartbeat of CariDream"]
    Wanderer["Moonlight Wanderer<br/>Gathers"]
    Conch["Moon Conch<br/>Remembers"]
    ...
    Tide["Silver Drum Tide<br/>Sacred Phenomenon"]
    Lantern["Lantern of Jacmel<br/>Foundational Legend"]
    Stories["Haitian stories and local characters"]
    Whisper["A whisper may emerge"]
    ...
    Haiti --> Golden
    Golden -. "may be sensed by" .-> Marasa
    Golden -. "may awaken" .-> Lumi
    Golden -. "may manifest as" .-> Tide
    Golden -. "may be reflected in legend" .-> Lantern
    Metres -. "may appear near remembered rhythm" .-> Golden
    ...
    Tide --> Stories
    Stories --> Whisper
    Whisper -. "may be gathered by" .-> Wanderer
```
...
The earlier Season 1 Silver Drum Tide finale approval was superseded by World Bible v2.9. The Sacred Phenomenon remains canon but is not part of the approved Season 1 outline or finale.
